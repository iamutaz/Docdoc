...
class _WebServices implements WebServices {
  ...
  @override
  Future<SignInResoinseBody> signin(SignInRequestBody signinrequestbody) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(signinrequestbody.toJson());
    final _options = _setStreamType<SignInResoinseBody>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'auth/register',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late SignInResoinseBody _value;
    try {
      _value = SignInResoinseBody.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
